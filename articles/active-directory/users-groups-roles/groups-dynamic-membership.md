...
```
NOTE:
For deviceOwnership in Intune it will be displayed as Corporate. 
More information please consult [Reference for devices entities](https://docs.microsoft.com/en-us/azure/active-directory/users-groups-roles/groups-dynamic-membership)
```
